                  ...
                  : Column(
                      children: [
                        ...
                        SizedBox(
                          ...
                          width: 90.w,
                          child: ListView.builder(
                              itemCount: ac.restaurantList.length,
                              shrinkWrap: true,
                              itemBuilder: (_, index) {
                                  ...
                                  onTap: () {
                                    ac
                                        .addRestaurantToBookHistory(
                                            id: ac.restaurantList[index].id
                                                .toString())
                                        .then((value) {
                                      Get.toNamed(
                                        AppPages.restaurantDetailScreen,
                                        arguments: ac.restaurantList[index],
                                      );
                                    });
                                  },
                                  child: Container(
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      width: 32.w,
                                                      child: Text(
                                                        '${ac.restaurantList[index].city}/${ac.restaurantList[index].country}',
                                                        style: Get
                                                            .theme
                                                            .textTheme
                                                            .labelSmall!
